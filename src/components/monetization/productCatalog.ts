...
export const PRODUCT_CATALOG: Record<string, ProductInfo> = {
  activation_individual: {
    ...
    priceUSD: 57,
    priceEUR: 47,
    priceIdBRL: "price_1Sw6EEDjhZZxZELMSmPNECig",
    priceIdUSD: "price_1Sw6F6DjhZZxZELMfBW3pn5q",
    priceIdEUR: "price_1Sw6FiDjhZZxZELMXDH1ACdx",
  ...
  nello_couple: {
    ...
    description: "O Mapa de Sinergia do seu relacionamento. 7 pilares cruzados: DISC, Eneagrama, Temperamentos, Inteligências, Arquétipos, Estilos de Conexão e Personalidade.",
    descriptionEn: "The Synergy Map of your relationship. 7 crossed pillars: DISC, Enneagram, Temperaments, Intelligences, Archetypes, Connection Styles and Personality.",
    benefits: [
    ...
    benefitsEn: [
      "Couple's behavioral dynamics (DISC)",
      "Deep motivations and tension points (Enneagram)",
      "Rhythm Protocol (Temperaments)",
      "Talent Synergy (Multiple Intelligences)",
      "The Couple's Myth (Archetypes)",
      "Natural roles: Direction Sensor and Builder",
      "Professional PDF report of 15-20 pages",
    ],
    priceBRL: 297,
    priceUSD: 59,
    priceEUR: 55,
    priceIdBRL: "price_1SvfhZDjhZZxZELMDKUinSpJ",
    priceIdUSD: "price_1SvfiPDjhZZxZELMjTrJTTLB",
    priceIdEUR: "price_1SvfjiDjhZZxZELMgYvA4BQY",
