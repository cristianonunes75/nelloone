...
export function DashboardStageJourney({
  ...
  return (
    ...
    >
      ...
      {/* Next Test Highlight Card */}
      {nextStep && (
        <motion.div 
          variants={itemVariants}
          className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border-2 border-primary/30 rounded-2xl p-6"
        >
          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {nextStep.status === "in_progress" ? "Continuar" : "Começar agora"}
              </Button>
