...
const getTranslations = (lang: string) => {
  const translations: Record<string, Record<string, any>> = {
    pt: {
      ...
      nelloReveals: 'Nello AI revela:',
      nelloPatterns: ['Seu gatilho emocional principal', 'O que te desorganiza', 'O que te cura', 'Como você briga', 'Como você pede ajuda', 'Como sua energia se regula'],
      ...
      closingTitle: '11. Encerramento com Nello AI',
    ...
    'pt-pt': {
      ...
      nelloReveals: 'Nello AI revela:',
      nelloPatterns: ['O teu gatilho emocional principal', 'O que te desorganiza', 'O que te cura', 'Como lutas', 'Como pedes ajuda', 'Como a tua energia se regula'],
      impactTitle: '7. Impacto do Temperamento nas Três Dimensões da Vida',
      relationships: 'Relacionamentos',
      work: 'Trabalho',
      innerLife: 'Vida Interior e Espiritualidade',
    ...
    en: {
      ...
      nelloReveals: 'Nello AI reveals:',
      nelloPatterns: ['Your main emotional trigger', 'What disorganizes you', 'What heals you', 'How you fight', 'How you ask for help', 'How your energy regulates'],
      ...
      closingTitle: '11. Closing with Nello AI',
