  ...
  const translations = {
    pt: {
      ...
      coverQuotes: {
        ...
        linguagens_amor: "O amor se expressa de formas únicas em cada coração.",
      ...
      selfExamQuestions: {
        ...
        linguagens_amor: "Qual é o cuidado que você está esperando que alguém te dê, mas que você mesmo pode oferecer?",
    ...
    'pt-pt': {
      ...
      coverQuotes: {
        ...
        linguagens_amor: "O amor expressa-se de formas únicas em cada coração.",
      ...
      selfExamQuestions: {
        ...
        linguagens_amor: "Qual é o cuidado que esperas que alguém te dê, mas que tu mesmo podes oferecer?",
    ...
    en: {
      coverQuotes: {
        ...
        linguagens_amor: "Love expresses itself uniquely in every heart.",
      ...
      selfExamQuestions: {
        ...
        linguagens_amor: "What is the care you're waiting for someone to give you, but that you can offer yourself?",
