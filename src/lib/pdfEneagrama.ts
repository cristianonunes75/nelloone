...
const getTranslations = (lang: string) => {
  const translations: Record<string, Record<string, any>> = {
    pt: {
      ...
      signedBy: 'Por Nello AI, seu guia no Nello One',
      ...
      nelloIntro: 'Você não é seu tipo. Você é a presença que observa o seu tipo. Essa jornada é um convite para acordar quem você sempre foi.',
      ...
      closingTitle: '11. Mensagem Final de Nello AI',
    ...
    'pt-pt': {
      ...
      signedBy: 'Por Nello AI, o teu guia no Nello One',
      ...
      nelloIntro: 'Tu não és o teu tipo. Tu és a presença que observa o teu tipo. Esta jornada é um convite para acordares quem sempre foste.',
    ...
    en: {
      ...
      signedBy: 'By Nello AI, your guide at Nello One',
      ...
      nelloIntro: 'You are not your type. You are the presence that observes your type. This journey is an invitation to awaken who you have always been.',
      ...
      closingTitle: '11. Final Message from Nello AI',
  ...
  const content: Record<number, Record<string, any>> = {
    1: {
      pt: {
        ...
        nelloMessage: 'Você não precisa ser perfeito para ser amado. Sua imperfeição é parte da sua humanidade. Quando você abraça suas falhas, encontra a paz que sempre buscou.',
      ...
      'pt-pt': {
        ...
        shadow: 'Rigidez, crítica implacável, raiva reprimida',
        light: 'Integridade, ética, sabedoria prática',
        nelloMessage: 'Tu não precisas ser perfeito para seres amado. A tua imperfeição é parte da tua humanidade. Quando abraças as tuas falhas, encontras a paz que sempre procuraste.',
      ...
      en: {
        ...
        nelloMessage: 'You do not need to be perfect to be loved. Your imperfection is part of your humanity. When you embrace your flaws, you find the peace you have always sought.',
    ...
    2: {
      pt: {
        ...
        nelloMessage: 'Você não nasceu para se sacrificar para ser amado. Você nasceu para amar sem perder a si mesmo. Seu amor é suficiente. Você é suficiente.',
      ...
      'pt-pt': {
        ...
        shadow: 'Possessividade emocional, manipulação afetiva',
        light: 'Amor que liberta, generosidade genuína',
        nelloMessage: 'Tu não nasceste para te sacrificares para seres amado. Nasceste para amar sem te perderes a ti mesmo. O teu amor é suficiente. Tu és suficiente.',
      ...
      en: {
        ...
        nelloMessage: 'You were not born to sacrifice yourself to be loved. You were born to love without losing yourself. Your love is enough. You are enough.',
    ...
    3: {
      pt: {
        ...
        nelloMessage: 'Você não é o que faz. Você é o que é. Quando para de performar e começa a ser, descobre que seu valor sempre esteve dentro de você.',
      ...
      'pt-pt': {
        ...
        shadow: 'Vaidade, falsidade, workaholismo',
        light: 'Autenticidade, inspiração, eficiência',
        nelloMessage: 'Tu não és o que fazes. Tu és o que és. Quando paras de performar e começas a ser, descobres que o teu valor sempre esteve dentro de ti.',
        triggers: ['Fracasso', 'Comparação desfavorável', 'Não ser admirado', 'Ineficiência'],
        healing: ['Parar de performar', 'Ser vulnerável', 'Valorizar o ser sobre o fazer'],
        virtue: 'Veracidade',
        passion: 'Vaidade',
      ...
      en: {
        ...
        nelloMessage: 'You are not what you do. You are what you are. When you stop performing and start being, you discover that your value was always within you.',
    ...
    4: {
      pt: {
        ...
        nelloMessage: 'Você não precisa ser diferente para ser amado. Sua singularidade já existe. Quando para de buscar o que falta, encontra o que sempre esteve presente.',
      ...
      'pt-pt': {
        ...
        shadow: 'Inveja, melancolia, auto-absorção',
        light: 'Criatividade, profundidade emocional, autenticidade',
        nelloMessage: 'Tu não precisas ser diferente para seres amado. A tua singularidade já existe. Quando paras de buscar o que falta, encontras o que sempre esteve presente.',
        triggers: ['Ser comum', 'Não ser compreendido', 'Perder identidade', 'Superficialidade'],
        healing: ['Aceitar o ordinário', 'Gratidão pelo presente', 'Conexão real'],
        virtue: 'Equanimidade',
        passion: 'Inveja',
      ...
      en: {
        ...
        nelloMessage: 'You do not need to be different to be loved. Your uniqueness already exists. When you stop seeking what is missing, you find what was always present.',
    ...
    5: {
      pt: {
        ...
        nelloMessage: 'Você não precisa entender tudo para viver. O conhecimento é ponte, não muro. Quando você compartilha o que sabe, encontra a conexão que sua alma busca.',
      ...
      'pt-pt': {
        ...
        nelloMessage: 'Tu não precisas entender tudo para viver. O conhecimento é ponte, não muro. Quando partilhas o que sabes, encontras a conexão que a tua alma procura.',
        triggers: ['Invasão', 'Demandas emocionais', 'Incompetência', 'Superficialidade'],
      ...
      en: {
        ...
        nelloMessage: 'You do not need to understand everything to live. Knowledge is a bridge, not a wall. When you share what you know, you find the connection your soul seeks.',
    ...
    6: {
      pt: {
        ...
        nelloMessage: 'A segurança que você busca não está fora. Está dentro. Quando confia em si mesmo, encontra a fé que transforma o medo em coragem.',
      ...
      'pt-pt': {
        ...
        shadow: 'Ansiedade, desconfiança, paranoia',
        light: 'Lealdade, coragem, compromisso',
        nelloMessage: 'A segurança que procuras não está fora. Está dentro. Quando confias em ti mesmo, encontras a fé que transforma o medo em coragem.',
        triggers: ['Incerteza', 'Traição', 'Autoridade ambígua', 'Abandono'],
        healing: ['Confiar no presente', 'Agir apesar do medo', 'Encontrar segurança interior'],
        virtue: 'Coragem',
        passion: 'Medo',
      ...
      en: {
        ...
        nelloMessage: 'The security you seek is not outside. It is inside. When you trust yourself, you find the faith that transforms fear into courage.',
    ...
    7: {
      pt: {
        ...
        nelloMessage: 'A alegria que você busca não está na próxima experiência. Está aqui, agora. Quando para de fugir da dor, encontra a paz que transforma tudo.',
      ...
      'pt-pt': {
        ...
        shadow: 'Fuga, superficialidade, impulsividade',
        light: 'Alegria genuína, gratidão, presença',
        nelloMessage: 'A alegria que procuras não está na próxima experiência. Está aqui, agora. Quando paras de fugir da dor, encontras a paz que transforma tudo.',
        triggers: ['Limitação', 'Tédio', 'Dor emocional', 'Compromissos rígidos'],
        healing: ['Permanecer na dor', 'Aprofundar experiências', 'Praticar moderação'],
        virtue: 'Sobriedade',
        passion: 'Gula (de experiências)',
      ...
      en: {
        ...
        nelloMessage: 'The joy you seek is not in the next experience. It is here, now. When you stop running from pain, you find the peace that transforms everything.',
    ...
    8: {
      pt: {
        ...
        nelloMessage: 'Sua força não precisa ser defesa. Pode ser abraço. Quando você permite a vulnerabilidade, encontra a verdadeira força: aquela que protege sem destruir.',
      ...
      'pt-pt': {
        ...
        shadow: 'Agressividade, dominação, vingança',
        light: 'Força protetora, justiça, magnanimidade',
        nelloMessage: 'A tua força não precisa ser defesa. Pode ser abraço. Quando permites a vulnerabilidade, encontras a verdadeira força: aquela que protege sem destruir.',
        triggers: ['Injustiça', 'Fraqueza percebida', 'Ser controlado', 'Traição'],
        healing: ['Permitir vulnerabilidade', 'Suavizar a força', 'Confiar nos outros'],
        virtue: 'Inocência',
        passion: 'Luxúria (por intensidade)',
      ...
      en: {
        ...
        nelloMessage: 'Your strength does not need to be defense. It can be an embrace. When you allow vulnerability, you find true strength: one that protects without destroying.',
    ...
    9: {
      pt: {
        ...
        nelloMessage: 'Sua paz não pode custar sua presença. Você importa. Quando se posiciona sem medo, encontra a harmonia que vem de dentro, não da fuga.',
      ...
      'pt-pt': {
        ...
        shadow: 'Apatia, auto-esquecimento, inércia',
        light: 'Paz verdadeira, presença, aceitação',
        nelloMessage: 'A tua paz não pode custar a tua presença. Tu importas. Quando te posicionas sem medo, encontras a harmonia que vem de dentro, não da fuga.',
        triggers: ['Conflito', 'Ser ignorado', 'Pressão para decidir', 'Mudanças bruscas'],
      ...
      en: {
        ...
        nelloMessage: 'Your peace cannot cost your presence. You matter. When you take a stand without fear, you find the harmony that comes from within, not from escape.',
