...
const getTranslations = (lang: 'pt' | 'pt-pt' | 'en') => ({
  pt: {
    ...
    day4: "Dia 4: Prática de presença (Nello orienta)",
  ...
  'pt-pt': {
    ...
    byMiguel: "Por Nello, o teu guia no Nello One",
  ...
  en: {
    ...
    byMiguel: "By Nello, your guide at Nello One",
    ...
    day4: "Day 4: Presence practice (Nello guides)",
