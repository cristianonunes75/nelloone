...
const simulationLabels: Record<SimulationLanguage, Record<string, string>> = {
  pt: {
    ...
    journey_description: 'Execute automaticamente todos os 7 testes e gere o Mapa Nello One',
    ...
    ask_miguel: 'Perguntar ao Miguel',
    miguel_analysis: 'Análise do Miguel',
  ...
  en: {
    ...
    journey_description: 'Automatically run all 7 tests and generate the Nello One Map',
    ...
    ask_miguel: 'Ask Miguel',
    miguel_analysis: 'Miguel\'s Analysis',
  ...
  es: {
    ...
    journey_description: 'Ejecutar automáticamente las 7 pruebas y generar el Mapa Nello One',
    ...
    ask_miguel: 'Preguntar a Miguel',
    miguel_analysis: 'Análisis de Miguel',
  ...
  it: {
    ...
    ask_miguel: 'Chiedi a Miguel',
    miguel_analysis: 'Analisi di Miguel',
  ...
  fr: {
    ...
    ask_miguel: 'Demander à Miguel',
    miguel_analysis: 'Analyse de Miguel',
