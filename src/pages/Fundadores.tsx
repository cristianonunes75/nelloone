...
const Fundadores = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-[hsl(216,28%,20%)] overflow-x-hidden">
      {/* Hero Section */}
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
              ...
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mt-4 sm:mt-6 mb-4 sm:mb-6 tracking-tight leading-tight">
                Torne-se um Fundador do{" "}
                <span className="text-[hsl(252,47%,40%)]">Nello One</span>
              </h1>
              
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed mb-6 sm:mb-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex flex-col sm:flex-row gap-2">
                      <Input
                        ...
                        className="w-full sm:max-w-[240px] uppercase"
                      />
                      {!couponApplied ? (
                        <Button
                          variant="outline"
                        ...
                        <Button
                          ...
                          className="text-destructive hover:text-destructive w-full sm:w-10"
                        >
                          <X className="w-4 h-4" />
                        </Button>
                      )}
              ...
              <CTAButton className="text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 w-full sm:w-auto" />
              
              <p className="text-xs sm:text-sm text-muted-foreground mt-4 sm:mt-6 flex items-center gap-2">
            ...
            <div className={`relative flex items-center justify-center transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'} hidden sm:flex`}>
              <div className="relative w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96">
                {/* Outer ring */}
                <div className="absolute inset-0 rounded-full border-2 border-[hsl(252,47%,40%)/0.1] animate-pulse" />
                {/* Middle rings */}
                <div className="absolute inset-4 sm:inset-6 rounded-full border-2 border-[hsl(252,47%,40%)/0.2]" />
                <div className="absolute inset-8 sm:inset-12 rounded-full border-2 border-[hsl(252,47%,40%)/0.3]" />
                <div className="absolute inset-14 sm:inset-20 rounded-full border-2 border-[hsl(252,47%,40%)/0.4]" />
                {/* Core */}
                <div className="absolute inset-20 sm:inset-28 rounded-full bg-gradient-to-br from-[hsl(252,47%,40%)] to-[hsl(252,50%,25%)] flex items-center justify-center shadow-2xl">
                  <div className="text-center">
                    <Sparkles className="w-8 h-8 sm:w-10 sm:h-10 text-[hsl(42,70%,55%)] mx-auto mb-1 sm:mb-2" />
                    <span className="text-white font-semibold text-xs sm:text-sm">Essência</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* O que é o Nello One */}
      <section className="py-10 sm:py-16 md:py-24 px-4 bg-[hsl(210,20%,97%)]">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6">O que é o Nello One</h2>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 border shadow-lg">
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-[hsl(210,20%,97%)] rounded-xl">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: `${item.color}20` }}>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed">
              Ser Fundador é entrar no Nello One <strong className="text-foreground">antes do lançamento oficial</strong>.<br className="hidden sm:block" />
              É caminhar junto. É participar da construção.<br className="hidden sm:block" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-8 sm:mb-12">
            {[
              ...
              <div key={index} className="flex items-start gap-3 bg-white rounded-xl p-3 sm:p-4 border shadow-sm hover:shadow-md transition-shadow">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[hsl(252,47%,40%)/0.1] flex items-center justify-center flex-shrink-0">
                  <item.icon className="w-4 h-4 sm:w-5 sm:h-5 text-[hsl(252,47%,40%)]" />
                </div>
          ...
          <div className="text-center">
            <p className="text-lg sm:text-xl font-medium text-foreground">É um lugar de honra.</p>
            <p className="text-lg sm:text-xl font-medium text-[hsl(252,47%,40%)]">E de construção real.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-16 md:py-24 px-4 bg-[hsl(210,20%,97%)]">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            <Wrench className="w-6 h-6 sm:w-8 sm:h-8 text-[hsl(252,47%,40%)]" />
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center">
              A Verdade
            </h2>
          </div>
          
          <p className="text-base sm:text-lg text-center text-[hsl(252,47%,40%)] font-medium mb-6 sm:mb-8 px-2">
            Esta versão ainda não está 100% perfeita — e é por isso que os Fundadores existem
          </p>
          
          <div className="bg-white rounded-2xl p-5 sm:p-8 border shadow-sm">
            ...
            <div className="bg-[hsl(252,47%,40%)/0.05] rounded-xl p-4 sm:p-6 border-l-4 border-[hsl(252,47%,40%)]">
            ...
            <p className="text-sm sm:text-base text-muted-foreground mt-4 sm:mt-6 text-center">
      ...
      <section className="py-10 sm:py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {/* Jornada Completa */}
            <div className="bg-white rounded-2xl p-5 sm:p-6 border-2 border-[hsl(252,47%,40%)/0.2] shadow-sm hover:border-[hsl(252,47%,40%)/0.4] transition-colors">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[hsl(252,47%,40%)] flex items-center justify-center mb-3 sm:mb-4">
                <Star className="w-5 h-5 sm:w-6 sm:h-6 text-[hsl(42,70%,55%)]" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Jornada Completa</h3>
              <p className="text-muted-foreground text-sm mb-3 sm:mb-4">Os sete testes oficiais:</p>
              <ul className="space-y-1.5 sm:space-y-2 text-sm text-muted-foreground">
                {["Arquétipos", "Inteligências Múltiplas", "Estilos de Conexão", "Nello 16", "DISC", "Eneagrama", "Temperamentos"].map((test, i) => (
                  <li key={i} className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[hsl(252,47%,40%)] flex-shrink-0" />
                    {test}
                  </li>
                ))}
              </ul>
              <p className="text-sm font-medium text-[hsl(42,70%,55%)] mt-3 sm:mt-4">+ Todos os PDFs Premium</p>
            </div>

            {/* Código da Essência */}
            <div className="bg-white rounded-2xl p-5 sm:p-6 border-2 border-[hsl(42,70%,55%)/0.3] shadow-sm hover:border-[hsl(42,70%,55%)/0.5] transition-colors">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[hsl(42,70%,55%)] flex items-center justify-center mb-3 sm:mb-4">
                <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Código da Essência</h3>
              <p className="text-muted-foreground text-sm mb-3 sm:mb-4">
                O relatório final mais profundo do Nello One.
              </p>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[hsl(42,70%,55%)/0.1] text-[hsl(42,60%,40%)] text-xs font-medium mb-3 sm:mb-4">
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-sm text-muted-foreground">
                {["Mapa emocional completo", "Forças essenciais", "Zonas de sombra", "Padrões ocultos", "Direcionamento prático"].map((item, i) => (
                  <li key={i} className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-[hsl(42,70%,55%)] flex-shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-6 border shadow-sm">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[hsl(252,47%,40%)/0.1] flex items-center justify-center mb-3 sm:mb-4">
                <Users className="w-5 h-5 sm:w-6 sm:h-6 text-[hsl(252,47%,40%)]" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Comunidade Fechada</h3>
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-6 border shadow-sm">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[hsl(252,47%,40%)/0.1] flex items-center justify-center mb-3 sm:mb-4">
                <Gift className="w-5 h-5 sm:w-6 sm:h-6 text-[hsl(252,47%,40%)]" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Atualizações 2.0</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-6 border shadow-sm">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[hsl(252,47%,40%)/0.1] flex items-center justify-center mb-3 sm:mb-4">
                <Heart className="w-5 h-5 sm:w-6 sm:h-6 text-[hsl(252,47%,40%)]" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Bônus Espiritual</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-6 border shadow-sm">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[hsl(252,47%,40%)/0.1] flex items-center justify-center mb-3 sm:mb-4">
                <Smartphone className="w-5 h-5 sm:w-6 sm:h-6 text-[hsl(252,47%,40%)]" />
              </div>
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3">Acesso ao App</h3>
              <p className="text-muted-foreground text-sm">
      ...
      <section className="py-10 sm:py-16 md:py-24 px-4 bg-[hsl(210,20%,97%)]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="overflow-x-auto -mx-4 px-4">
            <table className="w-full min-w-[320px] bg-white rounded-2xl border overflow-hidden shadow-sm">
              <thead>
                <tr className="border-b bg-[hsl(210,20%,97%)]">
                  <th className="text-left p-2.5 sm:p-4 font-semibold text-xs sm:text-sm">Recurso</th>
                  <th className="text-center p-2.5 sm:p-4">
                    <div className="flex items-center justify-center gap-1 sm:gap-2">
                      <Crown className="w-3 h-3 sm:w-4 sm:h-4 text-[hsl(42,70%,55%)]" />
                      <span className="font-semibold text-[hsl(252,47%,40%)] text-xs sm:text-sm">Fundadores</span>
                    </div>
                  </th>
                  <th className="text-center p-2.5 sm:p-4 font-semibold text-muted-foreground text-xs sm:text-sm">Público</th>
                </tr>
              </thead>
              <tbody>
                {[
                  { resource: "Jornada Completa", founders: "Incluída", public: "R$ 597" },
                  { resource: "Código da Essência", founders: "Incluído", public: "R$ 397" },
                  ...
                  <tr key={index} className="border-b last:border-0 hover:bg-[hsl(210,20%,98%)] transition-colors">
                    <td className="p-2.5 sm:p-4 font-medium text-xs sm:text-sm">{row.resource}</td>
                    <td className="p-2.5 sm:p-4 text-center">
                      <span className="inline-flex items-center gap-1 text-[hsl(252,47%,40%)] font-medium text-xs sm:text-sm">
                        {(row.founders === "Sim" || row.founders === "Incluída" || row.founders === "Incluído" || row.founders === "Incluídos" || row.founders === "Gratuitas") && (
                          <Check className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
                        )}
                        <span className="whitespace-nowrap">{row.founders}</span>
                      </span>
                    </td>
                    <td className="p-2.5 sm:p-4 text-center text-muted-foreground text-xs sm:text-sm whitespace-nowrap">{row.public}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <section className="py-10 sm:py-16 md:py-24 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-12 border-2 border-[hsl(252,47%,40%)/0.2] shadow-xl">
            <p className="text-muted-foreground mb-2 text-sm sm:text-base">Preço oficial no lançamento:</p>
            <p className="text-xl sm:text-2xl text-muted-foreground line-through mb-4 sm:mb-6">R$ 597</p>
            
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-[hsl(42,70%,55%)/0.1] text-[hsl(42,60%,40%)] font-medium mb-3 sm:mb-4 text-xs sm:text-sm">
              <Crown className="w-3 h-3 sm:w-4 sm:h-4" />
              Preço exclusivo Fundadores
            </div>
            
            <p className="text-4xl sm:text-5xl md:text-6xl font-bold text-[hsl(252,47%,40%)] mb-2">R$ 197</p>
            <p className="text-muted-foreground mb-6 sm:mb-8 text-sm sm:text-base">à vista</p>
            
            <div className="flex items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              <div className="h-px bg-border flex-1" />
              <span className="text-muted-foreground text-xs sm:text-sm">ou</span>
              <div className="h-px bg-border flex-1" />
            </div>
            
            <p className="text-xl sm:text-2xl font-semibold mb-6 sm:mb-8">3x de R$ 79</p>
            
            <CTAButton className="w-full text-base sm:text-lg py-5 sm:py-6" />
            
            <p className="text-xs sm:text-sm text-muted-foreground mt-4 sm:mt-6 italic">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            {[
              ...
              <div key={index} className="flex items-start gap-3 bg-white rounded-xl p-3 sm:p-4 border shadow-sm">
                <Heart className="w-4 h-4 sm:w-5 sm:h-5 text-[hsl(252,47%,40%)] mt-0.5 flex-shrink-0" />
      ...
      <section className="py-10 sm:py-16 md:py-24 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute left-5 sm:left-6 top-0 bottom-0 w-0.5 bg-[hsl(252,47%,40%)/0.2]" />
            ...
            {[
              ...
              <div key={index} className="relative pl-14 sm:pl-16 pb-6 sm:pb-8 last:pb-0">
                <div className="absolute left-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[hsl(252,47%,40%)] flex items-center justify-center text-white font-bold shadow-lg text-sm sm:text-base">
                  {item.step}
                </div>
      ...
      {/* CTA Final */}
      <section className="py-12 sm:py-20 md:py-32 px-4 bg-[hsl(252,47%,40%)]">
        <div className="max-w-3xl mx-auto text-center">
          <Crown className="w-10 h-10 sm:w-12 sm:h-12 text-[hsl(42,70%,55%)] mx-auto mb-4 sm:mb-6" />
          ...
          <Button 
            ...
            disabled={isLoading}
            size="lg"
            className="bg-[hsl(42,70%,55%)] hover:bg-[hsl(42,70%,50%)] text-[hsl(252,50%,25%)] font-semibold text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 rounded-full shadow-lg hover:shadow-xl transition-all w-full sm:w-auto"
          >
            {isLoading ? (
              <>
